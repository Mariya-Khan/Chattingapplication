...
import static chatting.application.Server.f1;
import javax.swing.*;
    ...
    Boolean typing;
     ...
     Client(){
        ...
        p1.add(l2);
         ...
         ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/video (1).png"));
